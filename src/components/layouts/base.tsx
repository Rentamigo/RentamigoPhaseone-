...
function Base() {
    ...
    try {
      switch (activeStep) {
        case 'form':
          ...
          const formResponse = await fetch('https://backend-lomi.onrender.com/api/properties/property', {
            method: 'POST',
            headers: {
        ...
        case 'location':
          ...
          await fetch('https://backend-lomi.onrender.com/api/properties/property-location', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
  ...
  // Transform extraRooms before sending
  const formattedFeaturesData = {
    ...featuresData,
    extraRooms: featuresData.extraRooms.includes("No Room")
      ? ["Gym Room"] // Replace "No Room" with "Gym Room"
      : featuresData.extraRooms,
    property: propertyId, // Keep property ID
  };

  await fetch('https://backend-lomi.onrender.com/api/properties/property-features', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
    body: JSON.stringify(formattedFeaturesData), // Send modified data
  });
  break;
        ...
        case 'amenities':
          if (!propertyId) throw new Error('Property ID is missing');
          await fetch('https://backend-lomi.onrender.com/api/properties/society-amenities', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
        ...
        case 'flatAmenities':
          if (!propertyId) throw new Error('Property ID is missing');
          await fetch('https://backend-lomi.onrender.com/api/properties/flat-amenities', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
        ...
        case 'restrictions':
          if (!propertyId) throw new Error('Property ID is missing');
          await fetch('https://backend-lomi.onrender.com/api/properties/property-restrictions', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
        ...
        case 'commercials':
          ...
          if (!propertyId) throw new Error('Property ID is missing');
          await fetch('https://backend-lomi.onrender.com/api/properties/property-commercials', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
        ...
        case 'availability':
          ...
          if (!propertyId) throw new Error('Property ID is missing');
          await fetch('https://backend-lomi.onrender.com/api/properties/property-availability', {
            method: 'POST',
            headers: {
              'Content-Type': 'application/json',
            },
