    ...
    const fetchPropertyDetails = async () => {
      try {
        ...
        const propertyResponse = await fetch(
          `https://backend-lomi.onrender.com/api/properties/propertyds/${propertyId}`
        );
        ...
        const featuresResponse = await fetch(
          `https://backend-lomi.onrender.com/api/properties/${propertyId}/features`
        );
        ...
        const availabilityResponse = await fetch(
          `https://backend-lomi.onrender.com/api/properties/${propertyId}/availability`
        );
        ...
        const restrictionsResponse = await fetch(
          `https://backend-lomi.onrender.com/api/properties/${propertyId}/restrictions`
        );
