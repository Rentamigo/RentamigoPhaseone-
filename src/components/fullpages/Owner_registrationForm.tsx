...
export default function PropertyRegistrationForm({ propertyId }: PropertyRegistrationFormProps) {
  ...
  useEffect(() => {
    const fetchPropertyDetails = async () => {
      try {
        const response = await fetch(`https://backend-lomi.onrender.com/api/properties/propertyds/${propertyId}`);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://backend-lomi.onrender.com/api/property/submit-form", {
        method: "POST",
